...
public class NMPIQueueManager implements Runnable {
	...
	/**
	 * Appends log messages to the job's log.
	 *
	 * @param id
	 *            The id of the job
	 * @param logToAppend
	 ...
	 *            (<tt>null</tt> if none)
	 * @param outputs
	 *            The outputs of the job (<tt>null</tt> if none)
	 * @param resourceUsage
	 *            Amount of resources used
	 * @param provenance
	 *            The collected provenance info (as JSON)
	 */
	public void setJobFinished(int id, String logToAppend,
			List<DataItem> outputs, long resourceUsage, ObjectNode provenance) {
	...
	public void setJobError(int id, String logToAppend, List<DataItem> outputs,
			Throwable error, long resourceUsage, ObjectNode provenance) {
